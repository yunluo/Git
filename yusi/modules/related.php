...
<img src="<?php echo post_thumbnail_src(); ?>?imageView2/1/w/185/h/110/q/85" alt="<?php the_title(); ?>" />	<br><span class="r_title"><?php the_title();?></span></a><?php } ?>
		<?php if( dopt('d_timthumbnail_b') ){?>
		<a href="<?php the_permalink();?>" title="<?php the_title();?>" target="_blank">
<img src="<?php echo get_bloginfo("template_url") ?>/timthumb.php?src=<?php echo post_thumbnail_src();?>&h=110&w=185&q=90&zc=1&ct=1" alt="<?php the_title();?>" />	<br><span class="r_title"><?php the_title();?></span></a><?php } ?>
		</li>
