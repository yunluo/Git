...
if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        if (git_get_option('git_cdnurl_b') ) {
            echo '<img class="thumb" style="width:375px;height:250px" src="';
            echo post_thumbnail_src();
            echo '?imageView2/1/w/375/h/250/q/75" alt="' . get_the_title() . '" />';
        } else {
            echo '<img class="thumb" style="width:375px;height:250px" src="' . get_template_directory_uri() . '/timthumb.php?src=';
            echo post_thumbnail_src();
            echo '&h=250&w=375&q=90&zc=1&ct=1" alt="' . get_the_title() . '" />';
        } ?>
			</div>
				</a>
				<h3><a href="<?php
