...
$values3 = get_post_custom_values('git_cs_download_link',$pid);
empty($values3) ? Header('Location:/') : $theCode3 = $values3[0];
$values4 = get_post_custom_values('git_download_link',$pid);
empty($values4) ? Header('Location:/') : $theCode4 = $values4[0];
?>
