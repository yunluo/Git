...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'git' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'git' ),
		'repeat-y'  => __( 'Repeat Vertically', 'git' ),
		'repeat'    => __( 'Repeat All', 'git' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'git' ),
		'top center'    => __( 'Top Center', 'git' ),
		'top right'     => __( 'Top Right', 'git' ),
		'center left'   => __( 'Middle Left', 'git' ),
		'center center' => __( 'Middle Center', 'git' ),
		'center right'  => __( 'Middle Right', 'git' ),
		'bottom left'   => __( 'Bottom Left', 'git' ),
		'bottom center' => __( 'Bottom Center', 'git' ),
		'bottom right'  => __( 'Bottom Right', 'git')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'git' ),
		'fixed'  => __( 'Fixed in Place', 'git')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'git' ),
		'italic'      => __( 'Italic', 'git' ),
		'bold'        => __( 'Bold', 'git' ),
		'bold italic' => __( 'Bold Italic', 'git' )
		);
