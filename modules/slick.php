<div class="slick">
	<?php
if (git_get_option('git_slick1_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick1url_b'); ?>"><img src="<?php
	...
	<?php
if (git_get_option('git_slick2_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick2url_b'); ?>"><img src="<?php
	...
	<?php
if (git_get_option('git_slick3_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick3url_b'); ?>"><img src="<?php
	...
	<?php
if (git_get_option('git_slick4_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick4url_b'); ?>"><img src="<?php
	...
	<?php
if (git_get_option('git_slick5_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick5url_b'); ?>"><img src="<?php
	...
	<?php
if (git_get_option('git_slick6_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick6url_b'); ?>"><img src="<?php
