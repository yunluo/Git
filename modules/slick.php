...
if (git_get_option('git_slick1img_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick1url_b'); ?>"><img width="360px" height="200px" src="<?php
...
if (git_get_option('git_slick2img_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick2url_b'); ?>"><img width="360px" height="200px" src="<?php
...
if (git_get_option('git_slick3img_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick3url_b'); ?>"><img width="360px" height="200px" src="<?php
...
if (git_get_option('git_slick4img_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick4url_b'); ?>"><img width="360px" height="200px" src="<?php
...
if (git_get_option('git_slick5img_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick5url_b'); ?>"><img width="360px" height="200px" src="<?php
...
if (git_get_option('git_slick6img_b')) { ?><div><a href="<?php
    echo git_get_option('git_slick6url_b'); ?>"><img width="360px" height="200px" src="<?php
