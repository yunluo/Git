...
<div class="footer-inner"><div class="fooert copyright" align="center"><?php if( dopt('d_footcode_b') ) echo dopt('d_footcode'); ?> &nbsp;Designed by <a target="_blank" href="http://yusi123.com">欲思</a> & <a id="yunluo" target="_blank" href="http://googlo.me">云落</a> <span class="trackcode pull-right"><?php if( dopt('d_track_b') ) echo dopt('d_track'); ?></span></div></div></footer>
