...
<div class="footer-inner"><div class="fooert copyright" align="center"><?php if( git_get_option('git_footcode') ) echo git_get_option('git_footcode'); ?> &nbsp;<?php if( !git_get_option('git_yunright') ) echo 'Designed by <a id="yunluo" target="_blank" href="http://googlo.me">云落</a>';?> <span class="trackcode pull-right"><?php if( git_get_option('git_track') ) echo git_get_option('git_track'); ?></span></div></div></footer>
