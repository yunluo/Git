		...
		<div class="comt">
			<div class="comt-box">
				...
				<div class="comt-ctrl">
					...
					<?php if(!git_get_option('git_lianjie')) echo '<span class="muted ml5 comt-ahref"><i class="fa fa-external-link"></i><a href="javascript:SIMPALED.Editor.ahref()" style="color:#999999"> 链接</a></span>';?>
