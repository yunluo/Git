...
<li><p class="first"><?php
    echo git_get_option('git_foottitle1'); ?></p><?php
    echo git_get_option('git_footconent1'); ?></li>
<li><p class="second"><?php
    echo git_get_option('git_foottitle2'); ?></p><?php
    echo git_get_option('git_footconent2'); ?></li>
<li><p class="third"><?php
    echo git_get_option('git_foottitle3'); ?></p><?php
    echo git_get_option('git_footconent3'); ?></li>
<li><p class="fourth"><?php
    echo git_get_option('git_foottitle4'); ?></p><?php
    echo git_get_option('git_footconent4'); ?></li>
</ul>
</div>
<?php
} ?>
...
if (git_get_option('git_footcode')) echo git_get_option('git_footcode'); ?> &nbsp;design by <a id="yunluo" target="_blank" href="http://googlo.me">云落</a> <span class="trackcode pull-right"><?php
