...
<?php if( dopt('d_black_b') ) echo '<div id="nav-header" class="navbar" style="border-bottom: 4px solid #616161 ;">'; ?>
...
<?php if( !dopt('d_red_b')&&!dopt('d_blue_b')&&!dopt('d_black_b')&&!dopt('d_purple_b')&&!dopt('d_yellow_b') ) echo '<div id="nav-header" class="navbar" style="border-bottom: 4px solid #03A9F4 ;">'; ?>
