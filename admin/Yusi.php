...
<tr>
        <td class="d_tit">代码高亮配色</td>
        <td>
		 Vibrant<label class="checkbox inline">
                <input type="checkbox" id="d_vibrant_b" name="d_vibrant_b" <?php if(dopt('d_vibrant_b')) echo 'checked="checked"' ?>>开启
            </label>
		 mondeki<label class="checkbox inline">
