...
<span class="d_tip"><?php Bing_show_category(); ?></span><br><hr />
    ...
    <tr>
        ...
        <td>
            幻灯片显示<label class="checkbox inline">
                <input type="checkbox" id="d_slick_b" name="d_slick_b" <?php if(dopt('d_slick_b')) echo 'checked="checked"' ?>>开启&nbsp;&nbsp;&nbsp;<span class="d_tip">本幻灯片与上方幻灯片不能同时开启，否则DUANG！！！</span>
            </label><br><hr />
			...
			幻灯片1标题<input type="smalltext" id="d_slick1title_b" name="d_slick1title_b" value="<?php echo dopt('d_slick1title_b'); ?>"><br><hr />
			...
			幻灯片2标题<input type="smalltext" id="d_slick2title_b" name="d_slick2title_b" value="<?php echo dopt('d_slick2title_b'); ?>"><br><hr />
			...
			幻灯片3标题<input type="smalltext" id="d_slick3title_b" name="d_slick3title_b" value="<?php echo dopt('d_slick3title_b'); ?>"><br><hr />
			...
			幻灯片4标题<input type="smalltext" id="d_slick4title_b" name="d_slick4title_b" value="<?php echo dopt('d_slick4title_b'); ?>"><br><hr />
			...
			幻灯片5标题<input type="smalltext" id="d_slick5title_b" name="d_slick5title_b" value="<?php echo dopt('d_slick5title_b'); ?>"><br><hr />
			...
			幻灯片6标题<input type="smalltext" id="d_slick6title_b" name="d_slick6title_b" value="<?php echo dopt('d_slick6title_b'); ?>"><br><hr />
    ...
    <tr>
        <td class="d_tit">顶部悬浮菜单</td>
        <td>
			<label class="checkbox inline">
                <input type="checkbox" id="d_topnav_b" name="d_topnav_b" <?php if(dopt('d_topnav_b')) echo 'checked="checked"' ?>>开启&nbsp;&nbsp;<span class="d_tip">开启后请再外观-菜单选项里面选择顶部菜单，这里如果不选，则顶部菜单无效</span>
            </label><br><hr />
        </td>
    </tr>
    <tr>
      ...
      列表Ajax下拉加载
		...
		七牛自定义域名<input placeholder="带http://哦" type="smalltext" id="d_cdnurl_b" name="d_cdnurl_b" value="<?php echo dopt('d_cdnurl_b'); ?>">
            &nbsp;&nbsp;
        ...
        <td>
		宽度：<input class="d_num" name="d_thumb_width" id="d_thumb_width" type="number" value="<?php echo dopt('d_thumb_width'); ?>">&nbsp;&nbsp;&nbsp;×
		高度：<input class="d_num" name="d_thumb_height" id="d_thumb_height" type="number" value="<?php echo dopt('d_thumb_height'); ?>"><span class="d_tip">为空则为主题默认尺寸，不建议修改，此处缩略图仅是指博客风格/分类目录文章缩略图</span><br><hr />
        </td>
    </tr>
	    <tr>
		...
		logo居左<label class="checkbox inline">
                <input type="checkbox" id="d_piclogo_left" name="d_piclogo_left" <?php if(dopt('d_piclogo_left')) echo 'checked="checked"' ?>>开启
            </label>
		...
		自定义配色<label class="checkbox inline">
                <input type="checkbox" id="d_custom_color" name="d_custom_color" <?php if(dopt('d_custom_color')) echo 'checked="checked"' ?>>开启
            </label>&nbsp;&nbsp;
		颜射代码<input placeholder="举例：#FFEB3B" type="smalltext" id="d_color_nom" name="d_color_nom" value="<?php echo dopt('d_color_nom'); ?>">&nbsp;&nbsp;
		hover颜射代码<input placeholder="举例：#FBC02D" type="smalltext" id="d_color_hover" name="d_color_hover" value="<?php echo dopt('d_color_hover'); ?>">
 ...
 <tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_toubuads_b" name="d_toubuads_b" <?php if(dopt('d_toubuads_b')) echo 'checked="checked"' ?>>开启
            </label>
            <textarea placeholder="会自动出现在网站logo右边，可放置广告代码等自定义（css或js）的全局代码块，仅在logo居左，非手机浏览的时候才会显示" name="d_toubuads" id="d_toubuads" type="textarea" rows="2"><?php echo dopt('d_toubuads'); ?></textarea><br><hr />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <textarea placeholder="广告区域，任意联盟广告和自定义广告的代码均可" name="d_fancydlad" id="d_fancydlad" type="textarea" rows=""><?php echo dopt('d_fancydlad'); ?></textarea><br><hr />
        </td>
    <tr>
        <td class="d_tit">弹窗下载版权声明</td>
        <td>
            <textarea placeholder="就是那种本文件收集自网络，有问题联系站长那些装X的文字" name="d_fancydlcp" id="d_fancydlcp" type="textarea" rows=""><?php echo dopt('d_fancydlcp'); ?></textarea><br><hr />
        </td>
    </tr>
    <tr>
