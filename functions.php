...
$imgurl='http://cn.bing.com'.$matches[1];
    echo'<style type="text/css">body{background: url('.$imgurl.');background-attachment:fixed;width:100%;height:100%;background-image:url('.$imgurl.');background-attachment:fixed;-moz-background-size: 100% 100%;-o-background-size: 100% 100%;-webkit-background-size: 100% 100%;background-size: 100% 100%;-moz-border-image: url('.$imgurl.') 0;background-attachment:fixed;background-repeat:no-repeat\9;background-image:none\9;}h1 a { background-image:url('.get_bloginfo('url').'/favicon.ico)!important;width:32px;height:32px;-webkit-border-radius:50px;-moz-border-radius:50px;border-radius:50px;}#login{width:320px;background:rgba(0,0,0,.2);padding:8% 20px 100% 12px;margin:auto;top:0;right:15%;position:fixed;box-shadow:0 0 5px 0 #333}.login form{margin-left:8px;padding:26px 24px 46px;font-weight:400;background:rgba(255,255,255,.2);border:none;-moz-box-shadow:none;-webkit-box-shadow:none;box-shadow:#000 0 0 10px -1px}#loginform{-webkit-border-radius:0;border-radius:0}.login form .input,.login input[type=text]{color:#555;font-weight:200;line-height:1;width:100%;padding:5px;margin-top:2px;margin-right:6px;margin-bottom:16px;background:#FFF!important;outline:0;-moz-box-shadow:none;-webkit-box-shadow:none;box-shadow:none;font-size:17px;padding-bottom:11px;padding-top:11px;text-indent:3px;border:2px solid #DCE4EC}input.button-primary{margin-top:8px;border:#000;font-weight:700;text-shadow:#FFF 0 0 10px}.login .button-primary{font-size:14px!important;line-height:22px;padding:8px 117px;border-radius:0}input.button-primary{background:rgba(255,255,255,.5);color:#000}input.button-primary:focus,input.button-primary:hover{background:rgba(255,255,255,.8);color:#000}input.button-primary:active{background:rgba(255,255,255,.2);color:#000}.login form .forgetmenot{font-weight:400;float:none;margin-top:-10px}.login #backtoblog,.login #nav{text-shadow:none;float:right;margin:0 30px 0 0;padding:16px 0 0 20px}.login #backtoblog a,.login #nav a{color:#FFF!important;text-decoration:none}.login #backtoblog a:hover,.login #nav a:hover{color:#444!important;text-decoration:none}.login #login_error,div.error{display:none}.login .message,div.updated{background-color:#E0FFE1;border-color:#ACE655}.wumii-footer{display:none!important}</style>';
}}
